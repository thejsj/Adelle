...
class __Mustache_96a05c1fec1e5fd9937a45a32b41890b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA2f193aea2c19db0e320f724e43a08f3($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function sectionA2f193aea2c19db0e320f724e43a08f3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
