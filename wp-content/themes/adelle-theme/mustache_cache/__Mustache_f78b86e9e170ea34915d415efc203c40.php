...
class __Mustache_f78b86e9e170ea34915d415efc203c40 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section2a6ab6f719a39451e6c79a32146b555d($context, $indent, $value);

        return $buffer;
    }

    private function section2a6ab6f719a39451e6c79a32146b555d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
		...
		<article class="project">
			...
			<div class="entry-content">
				...
				<img class="main-image" src="{{ featured_image.get_url() }}">
