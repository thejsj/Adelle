...
class __Mustache_ea9516fee0b6ef02ff2ac8da236179db extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '" class="reveal-modal single-modal project-modal" data-reveal>
';
...
';
        ...
        $buffer .= $this->section45aad1948a127d0d885ffaca4c147e9c($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section45aad1948a127d0d885ffaca4c147e9c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
			...
			<div class="main-video">
				<iframe src="//player.vimeo.com/video/88054119" width="596" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
			</div>
		';
...
';
                $buffer .= $indent . '				<iframe src="//player.vimeo.com/video/88054119" width="596" height="400" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
';
                $buffer .= $indent . '			</div>
';
                $context->pop();
