...
class __Mustache_ea62bd4611aac63401d5226001933c53 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('related_projects');
        $buffer .= $this->section1e355678106ea4ce75b8b4521e13c69e($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function section1e355678106ea4ce75b8b4521e13c69e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
