...
class __Mustache_be6b73dd9b49cb543f3c91c1480917e2 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionB3beb57387e8a543242189528904356b($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function sectionB3beb57387e8a543242189528904356b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
