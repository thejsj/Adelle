...
class __Mustache_ad9389728ecc98dc044cb69b97ec3e2a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0fb31f0c32ed3684afeda9e446b71e32($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function section0fb31f0c32ed3684afeda9e446b71e32(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
