...
class __Mustache_e8fb107dc0c7e02f961564a9aa90d2a3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF421ac546d768eb0f4e55a7a5a5e18bc($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function sectionF421ac546d768eb0f4e55a7a5a5e18bc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
