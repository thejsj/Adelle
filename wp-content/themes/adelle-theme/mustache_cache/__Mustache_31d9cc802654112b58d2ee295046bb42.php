...
class __Mustache_31d9cc802654112b58d2ee295046bb42 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section7d305872249ea24e45d2ba59468972a1($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function section7d305872249ea24e45d2ba59468972a1(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
					<li><a href="{{ permalink }}">!! Title : {{ post_title }}</a></li>
				';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
