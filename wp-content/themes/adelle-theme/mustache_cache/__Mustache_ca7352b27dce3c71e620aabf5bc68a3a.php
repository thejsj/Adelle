...
class __Mustache_ca7352b27dce3c71e620aabf5bc68a3a extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionEa13a768bb2e3bce6819c260a7448192($context, $indent, $value);
        $buffer .= $indent . '			</ul>
';
        $buffer .= $indent . '		</div>
';
...
';
    ...
    private function sectionEa13a768bb2e3bce6819c260a7448192(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
            $source = '
					<li class="{{ class }}"><a href="{{ permalink }}">{{ post_title }}</a></li>
				';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
