...
class __Mustache_45b8d7289e0552a831430574fc6ace65 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section61f5602da11d5b18946c7790a0d25e44($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '			<h2 class="change-color">
';
...
';
    ...
    private function section61f5602da11d5b18946c7790a0d25e44(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        if (!is_string($value) && is_callable($value)) {
			...
			<div class="main-video">
				<iframe src="//player.vimeo.com/video/88054119" width="596" height="350" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
			</div>
		';
...
';
                $buffer .= $indent . '				<iframe src="//player.vimeo.com/video/88054119" width="596" height="350" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
';
                $buffer .= $indent . '			</div>
';
                $context->pop();
